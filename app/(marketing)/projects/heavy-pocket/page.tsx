...
export default function HeavyPocketProject() {
  const project = getProject('heavy-pocket');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            Heavy Pocket brings enterprise-grade financial analysis to your personal finances.
            Get insights that matter, track spending patterns, forecast budgets, and make informed
        ...
        <section className="bg-slate-50 dark:bg-slate-900 rounded-lg p-8 border border-slate-200 dark:border-slate-800 text-center">
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Take Control of Your Finances</h3>
          <p className="text-slate-600 dark:text-slate-400 mb-6">
            Get CFO-level insights into your personal and business finances.
          </p>
