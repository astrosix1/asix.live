...
const supabase = createClient(
  'https://yhrsalezyzymkayinipu.supabase.co',
  'sb_publishable_Pmurq_TTfrr-gTO8rInHqA_68GTnruN'
);
...
(async () => {
  try {
    ...
    console.log('✓ Blog post published to asix.live!');
    console.log('URL: https://asix.live/blog/' + post.slug);
    process.exit(0);
  } catch (err) {
